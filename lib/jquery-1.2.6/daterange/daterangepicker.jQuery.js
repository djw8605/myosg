...
jQuery.fn.daterangepicker = function(settings){
	...
	jQuery.fn.clickActions = function(){
            var rp = $(this).parents(".ui-daterangepicker:first");
            var rpPickers = rp.children(".ranges");
            var doneBtn = rpPickers.children(".btnDone");
	...
	jQuery(this).click(function(){
                //hide any other pickers
                $(document).find(".ui-daterangepicker").hide();
