...
class Plugin_MetricUpdate
{
    ...
    private function processVoSupported($resource_id, $metric_id, $metric)
    {
        ...
        /*
        //test
        $detail = "# List of VOs this site claims to support \niVDgL OSG DES FMRI FERMILAB NANOHUB LIGO CDF DZERO GADU GRASE GridEx SDSS CMS ATLAS ops GLOW nwicg GROW engage";
        */
