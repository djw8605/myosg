...
class ResourceGroup extends CachedIndexedModel
{
    public function sql($params)
    {
        ...
        $where = "where disable = 0 and resource_group_id in (select resource_group_id from oim.resource_resource_group group by resource_group_id)";
        ...
        $sql = "SELECT rg.*, t.short_name as grid_type, active FROM oim.resource_group rg join oim.osg_grid_type t on rg.osg_grid_type_id = t.grid_type_id $where order by name";
        dlog($sql);
        return $sql;
    }
