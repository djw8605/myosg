...
class SupportCenterContact extends CachedModel
{
    public function sql($params)
    {
        ...
        return "SELECT sc.person_id, p.first_name, p.last_name, t.description as contact_type, r.description as rank_type from oim.sc_contact sc ".
