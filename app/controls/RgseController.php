...
class RgseController extends RgGratiaController
{
    ...
    public function map() {
	  ...
	  $urlbase = config()->gratiaweb."transfer-summary?orgId=1&panelId=28&var-VOName=All&var-Project=All&var-User=All&var-Probe=All&var-interval=1d&";//"/status_graphs/status_vo";
